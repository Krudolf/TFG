...
PlayerInfo::PlayerInfo(Player* p_owner, float p_posX, float p_posY)
{
	...
	float	t_offsetY	= 10;
	float	t_barSizeX	= t_sizeX * 0.25;
	float	t_barSizeY	= 32;
	float	t_barPosX	= t_pos.x + t_sizeX * -0.25;
	float	t_barPosX2	= t_pos.x + t_sizeX * 0.25;
	...
	float	t_statPosX2 = t_pos.x + t_sizeX * -0.15;
	float	t_statPosX3 = t_pos.x + t_sizeX * 0.05;
	float	t_statPosX4	= t_pos.x + t_sizeX * 0.25;
